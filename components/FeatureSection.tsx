...
export default function FeatureSection({
  ...
  const imageSrc = imageUrl || `https://images.unsplash.com/photo-${Math.random() > 0.5 ? '1551288049-bebda4e38f71' : '1460925895917'}-afdab827c52f?w=800&h=600&fit=crop`;
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <p className="mb-6 text-lg font-semibold text-gray-600">{description}</p>
            <motion.a
              href={ctaLink}
              whileHover={{ x: 5 }}
            ...
            {testimonial && (
              ...
              >
                ...
                <p className="mb-4 font-medium text-gray-700">{testimonial.quote}</p>
          ...
          <motion.div
            ...
            className="flex-1"
          >
            <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-violet-50 to-purple-50 p-8 shadow-lg overflow-hidden">
